...
const Card = ({ title, description }) => {
  return (
    <div className="bg-primary-bg flex flex-col justify-center py-9 rounded-lg shadow-md">
      <div
        style={{ borderRadius: 30, borderWidth: 1, width: 60, height: 60 }}
        className="bg-primary-txt mx-5 mb-2 flex justify-center items-center"
      >
        <svg
      ...
      <div className="italic text-primary-txt mx-5 mb-2 font-bold">{title}</div>
